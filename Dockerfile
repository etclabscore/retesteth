...
# Geth
RUN git clone --depth 1 -b merge/foundation-release/1.10.23-tests-generate-fixes-statefix-difficulty-test-v2 https://github.com/etclabscore/core-geth.git /geth
